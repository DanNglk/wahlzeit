...
public class SysConfig extends AbstractConfig {
	...
	public SysConfig(String myRootDir) {
		...
		doSetValue(SysConfig.DB_CONNECTION, "jdbc:postgresql://localhost:5432/knogl");
		doSetValue(SysConfig.DB_USER, "knogl");
		doSetValue(SysConfig.DB_PASSWORD, "jctNQxAomwDnoDlk");
	}
